...
(function () {
    ...
    function tick() {
        ...
        imgToLogo.set(img, next);  /* atualiza ANTES do setTimeout pra próximos ticks já enxergarem */
        img.style.opacity = '0';
...
(function () {
    ...
    function trigger() { return secFaq.offsetTop - window.innerHeight; }
    ...
    function revealSec2() {
        ...
        if (eyebrow) {
            ...
            eyebrow.style.filter     = 'blur(16px)';
        ...
        if (desc) {
            ...
            desc.style.filter     = 'blur(16px)';
            desc.style.transform  = 'translateY(16px)';
        }
        if (actions) {
            actions.style.transition = 'none';
            actions.style.opacity    = '0';
            actions.style.filter     = 'blur(16px)';
