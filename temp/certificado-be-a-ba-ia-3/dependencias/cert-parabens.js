/* ══════════════════════════════════════════════════════════════════════════
   ...
   ══════════════════════════════════════════════════════════════════════════ */
(function () {
    var BADGE_SRC = '/temp/certificado-be-a-ba-ia-3/dependencias/Badge-B%C3%AA-a-B%C3%A1-IA-3.png';        /* PNG grande, alta qualidade — só pro download */
    var BADGE_PREVIEW = '/temp/certificado-be-a-ba-ia-3/dependencias/Badge-B%C3%AA-a-B%C3%A1-IA-3-200.webp'; /* leve (200x200) — badge animado no popup */
    ...
    var BASE = '/temp/certificado-be-a-ba-ia-3/dependencias/';
    var CERT_JPG = BASE + 'certificado-B%C3%AA-a-B%C3%A1-IA-3.jpg';
    ...
    function montarPdf(jpg, regFont, boldFont, nome) {
        ...
        var L3 = 'pela participação no';
        var L4 = 'Bê-a-Bá da IA 3.0,';
        var L5 = 'realizado no sábado, 29 de agosto de 2026, das 9h às 16h.';
