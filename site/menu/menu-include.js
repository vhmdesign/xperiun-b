        ...
        fetch(menuHtmlUrl)
            ...
            .then(function (html) {
                ...
                var rewriteRelative = function (el, attr) {
                    ...
                    /* .replace(/^\/site\//, '/'): em produção o conteúdo vive
                       em public_html/site/ mas o .htaccess externo esconde
                       /site/ da URL pública. Sem o replace, cada asset gerado
                       aqui passaria por um 301 redundante. */
                    el[attr] = new URL('../' + val, scriptUrl).pathname.replace(/^\/site\//, '/');
                };
